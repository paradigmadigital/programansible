...
class Options(object):
    ...
    def __init__(self, verbosity=None, inventory=None, listhosts=None,
                 subset=None, module_paths=None, extra_vars=None, forks=10,
                 ask_vault_pass=None, vault_password_files=None,
                 new_vault_password_file=None, output_file=None, tags=[],
                 skip_tags=[], one_line=None, tree=None, ask_sudo_pass=None,
